    ...
    <div class="modal-dialog add-category-modal">
      ...
      <div class="modal-content rounded-0">
        <div class="modal-header rounded-0">
          ...
          <h2 class="modal-title text-center">Create New Task</h2>
        </div>
                ...
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_task_post" class="btn btn-primary rounded-0 btn-sm">Create Task</button>
                    </div>
                    <div class="col-sm-3">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom rounded-0">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="btn-group">
                <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-info btn-menu" data-toggle="modal" data-target="#myModal">Create New Task</button>
                </div>
              <?php } ?>
          ...
          <center ><h3>Project Management Section</h3></center>
          <div class="gap"></div>
