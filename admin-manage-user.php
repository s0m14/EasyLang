...
<style>
  body {
    background-image: url('images/hands.png'); /* Replace 'background.jpg' with your image file */
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center">Add Translator Info</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="">
                      <input type="text" placeholder="Enter Translator Name" name="em_fullname" list="expense" class="form-control input-custom" id="default" required>
                    </div>
                  </div>
                   <div class="form-group">
                    <label class="control-label text-p-reset">Username</label>
                    <div class="">
                      <input type="text" placeholder="Enter Translator username" name="em_username" class="form-control input-custom" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label text-p-reset">Email</label>
                    <div class="">
                      <input type="email" placeholder="Enter Translator Email" name="em_email" class="form-control input-custom" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_new_employee" class="btn btn-primary btn-sm rounded-0">Add Translator</button>
                    </div>
                    <div class="col-sm-3">
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <?php } ?>
            <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-primary-custom btn-menu" data-toggle="modal" data-target="#myModal">Add New Translator</button>
                </div>
              <?php } ?>
          <ul class="nav nav-tabs nav-justified nav-tabs-custom">
            <li><a href="manage-admin.php">Manage Admin</a></li>
            <li class="active"><a href="admin-manage-user.php">Manage Translators</a></li>
          </ul>
          <div class="gap"></div>
